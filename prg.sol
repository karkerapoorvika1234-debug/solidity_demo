...
contract OrderTracker {
    ...
    function getOrderStatusString(uint _orderId) public view returns (string memory) {
        ...
        if (supports == OrderStatus.intransitpointb) return "intransitpointb";
